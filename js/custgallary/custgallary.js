...
Product.Gallery.prototype = {
    ...
    updateImage : function(file) {
        ...
        this.images[index].label = this
                ...
                this.images[index].reviewername = this
                .getFileElement(file, 'cell-reviewername input').value;

                this.images[index].productid = this
                .getFileElement(file, 'cell-productid input').value;

        this.images[index].review = this
                .getFileElement(file, 'cell-review textarea').value;
    ...
    updateVisualisation : function(file) {
        ...
        this.getFileElement(file, 'cell-review textarea').value = image.review;
        this.getFileElement(file, 'cell-reviewername input').value = image.reviewername;
        this.getFileElement(file, 'cell-productid input').value = image.productid;
