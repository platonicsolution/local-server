 ...
 */
class Psolz_Returnpolicy_Varien_Data_Form_Element_Image extends Varien_Data_Form_Element_Abstract
    ...
    public function getElementHtml()
    {
        ...
        if ((string)$this->getValue()) {
            ...
            $html = '<a href="' . $url . '"'
                ...
                . ' alt="' . $this->getValue() . '" height="200" width="250" class="small-image-preview v-middle" />'
                . '</a> ';
        }
